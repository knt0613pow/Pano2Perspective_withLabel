...
def id_angle2name(id, angle, idx2lat, idx2lng):
    lat = round(idx2lat[id], 7)
    lng = round(idx2lng[id],7)
...
if __name__ == "__main__":
    ...
    Pair_path = os.path.join(Region_path, 'perspective_data')
    ...
    for i, point in enumerate(path.path):
        ...
        for idx, angles in valid_image_list.items():
            ...
            for angle in angles:
                ...
                with open (os.path.join(Pair_path, label_name), "w" ) as json_file:
